...
Planning out all the Shape's positions, storing values using arrays and modifying them, clearing the board for combos,
...
Controls: ```Left, Right, Down to move. Z, X to rotate. Shift to hold and exchange shapes. Space to drop and lock.```
